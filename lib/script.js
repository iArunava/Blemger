        ...
        <div>
            ...
            <div class="columns margin--bottom-0">
                <div class="column is-12 slider-container">
                    <input id="id--slider${img_no}-${bar_for}" type="range" min="0" max="100" value="100" class="slider slider--${bar_for}">
                </div>
            </div>
            <p class="text--center"> ${bar_for.toUpperCase()} value : <span id="id--simg${img_no}-${bar_for}">1.00</span>
        </div>
    `;
    return template;
}
