...
function blend() {
    ...
    let nimg1 = document.getElementById('id--negate-image1');
    let nimg2 = document.getElementById('id--negate-image2');
    ...
    for (i = 0; i < imgData1.data.length; i += 4) {
        ...
        imgData1.data[i+1] = imgData1.data[i+1]*gval1 + imgData2.data[i+1]*gval2;
        imgData1.data[i+2] = imgData1.data[i+2]*bval1 + imgData2.data[i+2]*bval2;

        if (isalpha.checked) {
            imgData1.data[i+3] = imgData1.data[i+3]*aval1 + imgData2.data[i+3]*aval2;
        } else {
